...
## 2.1 :: Monospaced <!-- Start Fold -->

Diagonal arrows:
↖ ↗ ↘ ↙

Up/down arrows with bars:
↞ ↟ ↠ ↡
...
Downwards arrow with tip downwards:
↨
...
Mathematical operators (arrow-like):
≪ ≫ ≺ ≻ ≤ ≥ < >
...
Supplemental Arrows-B - curved and bent:
⤀ ⤁ ⤂ ⤃ ⤄ ⤅ ⤆ ⤇ ⤈ ⤉ ⤊ ⤋ ⤌ ⤍ ⤎ ⤏ ⤐ ⤑ ⤒ ⤓ ⤔ ⤕ ⤖ ⤗ ⤘ ⤙ ⤚ ⤛ ⤜ ⤝ ⤞ ⤟ ⤠ ⤡ ⤢ ⤣ ⤤ ⤥ ⤦ ⤧ ⤨ ⤩ ⤪ ⤫ ⤬ ⤭ ⤮ ⤯ ⤰ ⤱ ⤲ ⤳ ⤴ ⤵ ⤶ ⤷ ⤸ ⤹ ⤺ ⤻ ⤼ ⤽ ⤾ ⤿

Supplemental Arrows-B - harpoons:
⥀ ⥁ ⥂ ⥃ ⥄ ⥅ ⥆ ⥇ ⥈ ⥉ ⥊ ⥋ ⥌ ⥍ ⥎ ⥏ ⥐ ⥑ ⥒ ⥓ ⥔ ⥕ ⥖ ⥗ ⥘ ⥙ ⥚ ⥛ ⥜ ⥝ ⥞ ⥟ ⥠ ⥡ ⥢ ⥣ ⥤ ⥥ ⥦ ⥧ ⥨ ⥩ ⥪ ⥫ ⥬ ⥭ ⥮ ⥯ ⥰ ⥱ ⥲ ⥳ ⥴ ⥵ ⥶ ⥷ ⥸ ⥹ ⥺ ⥻ ⥼ ⥽ ⥾ ⥿

Miscellaneous Symbols - arrows and geometric:
⬀ ⬁ ⬂ ⬃ ⬄ ⬈ ⬉ ⬊ ⬋ ⬌ ⬍ ⬎ ⬏ ⬐ ⬑ ⬰ ⬱ ⬲ ⬳ ⬴ ⬵ ⬶ ⬷ ⬸ ⬹ ⬺ ⬻ ⬼ ⬽ ⬾ ⬿ ⭀ ⭁ ⭂ ⭃ ⭄ ⭅ ⭆ ⭇ ⭈ ⭉ ⭊ ⭋ ⭌ ⭍ ⭎ ⭏ ⭶ ⭷ ⭸ ⭹ ⭺ ⭻ ⭼ ⭽ ⭾ ⭿ ⮀ ⮁ ⮂ ⮃ ⮄ ⮅ ⮆ ⮇ ⮈ ⮉ ⮊ ⮋ ⮌ ⮍ ⮎ ⮏ ⮐ ⮑ ⮗

Triangle-headed arrows - basic:
⮔ ⮕ ⮒ ⮓

Triangle-headed arrows - paired/overlapping:
⭚ ⭛ ⭜ ⭝ ⭞ ⭟

Triangle-headed arrows - with tail:
⮘ ⮙ ⮚ ⮛ ⮜ ⮝ ⮞ ⮟

Triangle-headed arrows - dashed:
⮠ ⮡ ⮢ ⮣ ⮤ ⮥ ⮦ ⮧

Triangle-headed arrows - to bar:
⮨ ⮩ ⮪ ⮫ ⮬ ⮭ ⮮ ⮯

Triangle-headed arrows - double horizontal stroke:
⮰ ⮱ ⮲ ⮳ ⮴ ⮵ ⮶ ⮷

Triangle-headed arrows - double vertical stroke:
⮸
⯅ ⯆ ⯇ ⯈

Triangle-headed arrows - double stroke:
⯬ ⯭ ⯮ ⯯
...
## 2.2 :: Not monospaced <!-- Start Fold -->

Arrows with stroke (not going through):
↚ ↛ ↜ ↝

Decorative arrows - mathematical/wide-headed:
➔ ➕ ➖ ➗ ➘ ➙ ➚ ➛ ➜ ➝ ➞ ➟ ➠ ➡

Decorative arrows - curved/heavy:
➢ ➣ ➤ ➥ ➦ ➧ ➨ ➩ ➪ ➫ ➬ ➭ ➮ ➯ ➰ ➱ ➲ ➳ ➴ ➵ ➶ ➷ ➸ ➹ ➺ ➻ ➼ ➽ ➾ ➿
...
cat > /tmp/organized_arrows.txt << 'EOF'
↖ ↗ ↘ ↙ ↞ ↟ ↠ ↡ ↢ ↣ ↤ ↥ ↦ ↧ ↨ ↩ ↪ ↫ ↬ ↭ ↮  ↯ ↕ ↔ ↰ ↱ ↲ ↳ ↴ ↵ ↶ ↷ ↸ ↹ ↺ ↻ ↼ ↽ ↾ ↿ ⇀ ⇁ ⇂ ⇃ ⇄ ⇅ ⇆ ⇇ ⇈ ⇉ ⇊ ⇋ ↓ → ⇌ ⇍ ⇎ ⇏ ⇐ ⇑ ⇒ ⇓ ⇔ ⇕ ⇖ ⇗ ⇘ ⇙ ⇚ ⇛ ⇜ ⇝ ⇞ ⇟ ⇠ ⇡ ⇢ ⇣ ⇤ ⇥ ↑ ⇦ ⇧ ⇨ ⇩ ⇪ ⇫ ⇬ ⇭ ⇮ ⇯ ⇰ ⇱ ⇲ ⇳ ⇴ ⇵ ⇶ ⇷ ⇸ ⇹ ⇺ ⇻ ⇼ ⇽ ⇾ ⇿ ←
