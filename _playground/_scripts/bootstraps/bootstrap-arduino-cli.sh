...
echo ""
echo "🔌 Required IDE Extensions:"
echo ""
echo "   1. Arduino Extension (choose one):"
echo "      - Arduino (Community Edition) - RECOMMENDED"
echo "        Extension ID: vscode-arduino.vscode-arduino-community"
echo "        Note: Microsoft's Arduino extension is deprecated as of Oct 2024"
echo ""
echo "      - OR Arduino (Microsoft) - if you had this before"
echo "        Extension ID: ms-vscode.vscode-arduino"
echo "        Note: Deprecated but may still work"
echo ""
echo "   2. C/C++ Extension (choose based on your IDE):"
echo ""
echo "      For CURSOR:"
echo "        Name: C/C++"
echo "        Extension ID: anysphere.cpptools"
echo "        Description: C/C++ IntelliSense, debugging, and code browsing."
echo "        VS Marketplace: https://marketplace.cursorapi.com/items/?itemName=anysphere.cpptools"
echo "        ⚠️  REQUIRES: clangd language server (install with: sudo apt install clangd)"
echo "        Note: Automatic installation only works on x86-64. On ARM (Raspberry Pi),"
echo "              you must install manually: sudo apt install clangd"
echo ""
echo "      For VSCODE:"
echo "        Name: C/C++ Extension Pack"
echo "        Extension ID: ms-vscode.cpptools-extension-pack"
echo "        Description: Popular extensions for C++ development in Visual Studio Code."
echo ""
echo "⚙️  VSCode Settings (add to .vscode/settings.json or user settings):"
echo "   {"
echo "     \"arduino.path\": \"$HOME/.local/bin/arduino-cli\","
echo "     \"arduino.additionalUrls\": ["
