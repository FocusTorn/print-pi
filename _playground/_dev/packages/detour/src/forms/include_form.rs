...
use crate::app::AddIncludeForm;
use crate::forms::base;

pub fn handle_char(form: &mut AddIncludeForm, c: char) {
...
pub fn handle_backspace(form: &mut AddIncludeForm) {
    let field = match form.active_field {
        0 => &mut form.target_path,
        1 => &mut form.include_path,
        2 => &mut form.description,
...
pub fn move_cursor_left(form: &mut AddIncludeForm) {
    base::move_cursor_left(&mut form.cursor_pos);
}

pub fn move_cursor_right(form: &mut AddIncludeForm) {
...
pub fn next_field(form: &mut AddIncludeForm) -> bool {
...
pub fn prev_field(form: &mut AddIncludeForm) {
...
pub fn complete_path(form: &mut AddIncludeForm) -> bool {
...
pub fn paste_clipboard(form: &mut AddIncludeForm) {
